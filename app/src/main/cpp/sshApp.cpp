...
POKE2 NAME = VALUE
*/
void sshApp::parserJoyPokes(const zArray<zString8>& sarr) {
...
zArray<zString8> sshApp::getAllNamesJoyPokes() const {
    zArray<zString8> all;
...
void sshApp::joyMakePresets(int id) const {
    // образцы
